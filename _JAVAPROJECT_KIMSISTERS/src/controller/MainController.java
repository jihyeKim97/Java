...
public class MainController implements Initializable {
	 ...
	 * 
	 * 라벨을 클릭하면 이벤트를 전달 받아서 실행되는 메소드. 라벨에 적힌 사용자의 연령대 값을 파라미터로 select 메소드에 전달함 해당
	 * 연령대가 즐겨찾기에 많이 등록한 식당을 내림차순으로 가져온다.
	 * 
	 * 만든이 : 김소진
	 */
	...
	public void recommendlabelSetting() {
		...
		ArrayList<String> guList = new ArrayList<String>(Arrays.asList("강남구", "관악구", "광진구", "동대문구", "마포구", "서대문구",
				"성동구", "성북구", "용산구", "은평구", "종로구", "중구", "중랑구"));
		RestaurantDAO restaurantDAO = new RestaurantDAO();
